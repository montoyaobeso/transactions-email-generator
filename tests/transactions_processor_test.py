...
class TestTransactionsProcessor(TestCase):
    ...
    def test_transactions_processor(self):
        ...
        df = df.rename(columns={"Id": "id", "Date": "date", "Transaction": "value"})

        expected_total_balance = 39.74
        expected_avg_credit_amount = 35.25
        expected_avg_debit_amount = -15.38
        expected_transactions_history = {"2024": [("July", 2), ("August", 2)]}
        ...
        self.assertTrue(tp.get_transactions_history() == expected_transactions_history)
